...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i3.JsonPlaceHolderAPIService>(
      () => _i3.JsonPlaceHolderAPIService(get<_i4.Dio>()));
  gh.factory<_i5.PhotoRepository>(() => _i5.PhotoRepositoryImpl(
      jsonPlaceHolderAPIService: get<_i3.JsonPlaceHolderAPIService>()));
  gh.factory<_i6.PostRepository>(() => _i6.PostRepositoryImpl(
      jsonPlaceHolderAPIService: get<_i3.JsonPlaceHolderAPIService>()));
  gh.factory<_i7.UpdateSelectedPostUseCase>(
      () => _i7.UpdateSelectedPostUseCase(get<_i6.PostRepository>()));
  gh.factory<_i8.UserRepository>(() => _i8.UserRepositoryImpl(
      jsonPlaceHolderAPIService: get<_i3.JsonPlaceHolderAPIService>()));
  gh.factory<_i9.AlbumRepository>(() => _i9.AlbumRepositoryImpl(
      jsonPlaceHolderAPIService: get<_i3.JsonPlaceHolderAPIService>()));
  gh.factory<_i10.CommentRepository>(() => _i10.CommentRepositoryImpl(
      jsonPlaceHolderAPIService: get<_i3.JsonPlaceHolderAPIService>()));
  ...
  gh.factory<_i15.PhotoBloc>(() => _i15.PhotoBloc(
      get<_i13.GetAllPhotosUseCase>(),
      get<_i13.GetPhotosFromAlbumIDUseCase>()));
  gh.factory<_i16.PostBloc>(() => _i16.PostBloc(
